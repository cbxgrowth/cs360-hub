      ...
      rootElement.innerHTML = `
        ...
        ">
          ...
          ">
            ...
            <h1 style="color: #2d3748; margin: 0 0 15px 0; font-size: 24px;">Configuração Incompleta</h1>
            <p style="color: #718096; margin: 0 0 20px 0; line-height: 1.5;">
              A aplicação não está configurada corretamente. Entre em contato com o administrador do sistema.
            </p>
