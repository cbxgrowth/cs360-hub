...
import { TrendingDown, Target, AlertTriangle, CheckCircle, Plus, Users, DollarSign } from 'lucide-react';
...
export const ChurnStrategiesTab = () => {
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>Estratégias Anti-Churn</CardTitle>
