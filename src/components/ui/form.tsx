...
const useFormField = () => {
  ...
  // Add protection against null form context
  if (!formContext) {
    console.error("useFormField must be used within a Form component. Make sure the component is wrapped with <Form>")
    // Return a safe default object to prevent the error
    return {
